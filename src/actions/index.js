...
export const setNowCountry = (para) => ({ type: 'setNowCountry', neo: para })
...
// 临时数据
export const setShowAiboChoosePage = (para) => ({ type: 'setShowAiboChoosePage', neo: para })
export const setShowGachaPage = (para) => ({ type: 'setShowGachaPage', neo: para })
...
export const setUserAiboInfo = (para) => ({ type: 'setUserAiboInfo', neo: para })
export const setUserDimenstal = (para) => ({ type: 'setUserDimenstal', neo: para })
export const setUserMapInfo = (para) => ({ type: 'setUserMapInfo', neo: para })
